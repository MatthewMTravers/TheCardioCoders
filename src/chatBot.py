...
# Custom prompt for 'Workout Plans'
...
def generate(state: State):
    ...
    # Add video links information if available
    video_links_info = ""
    if state.get("video_links"):
        video_links_info = "\n\n### Video Demonstration Links:\n"
        for exercise in state["video_links"]:
            video_links_info += f"- **{exercise['name']}**: [Full Video]({exercise['video_url']}), [Short Clip]({exercise['short_url']})\n"

    # Combine context and video links
